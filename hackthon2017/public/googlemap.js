...
function getWeb(){
 ...
 //signup page js _______________________________________
...
function signUp(){
    ...
    xhttp.send(JSON.stringify({name:charityName, password:password, phonenumber:phoneNum, lng:lontitute, lat:latitute, lat:userlat, tag:tag, web:website, descrip:description}));
}
